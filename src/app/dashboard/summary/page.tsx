export default function SUmmaryPage() {
  return (
    <div className="h-full flex flex-col items-center justify-center p-8 bg-slate-50/50 mt-48">
      <div className="bg-white p-8 rounded-xl border border-slate-200 shadow-sm max-w-2xl w-full">
        ...
        <div className="flex justify-end pt-4 border-t border-slate-100">
           <button 
             ...
             className="bg-blue-600 text-white px-8 py-2.5 text-sm font-bold rounded-lg shadow hover:bg-blue-700 hover:shadow-md transition-all duration-200 transform active:scale-95 flex items-center gap-2"
           >
